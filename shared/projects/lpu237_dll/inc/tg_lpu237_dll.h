...
*/
DWORD _CALLTYPE_ LPU237_get_list(wchar_t* ssDevPaths);
...
*		else the number of connected lpu237 device.
*/
DWORD _CALLTYPE_ LPU237_get_list_w(wchar_t* ssDevPaths);
...
*	else : result is success
*/
BOOL _CALLTYPE_ LPU237_SCR_helper_GetATRParameterString_w(wchar_t* sOut, LPDWORD lpnOut, CONST BYTE* sAtr, DWORD nAtr, wchar_t cDelimiter);
