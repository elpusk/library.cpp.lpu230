...
*/
class _vhid_info_lpu238 : public _vhid_info
{
public:
	typedef	std::shared_ptr<_vhid_info_lpu238>	type_ptr;
...
private:
	...
	typedef	std::map<_mp::type_bm_dev,_vhid_info_lpu238::_type_tuple_info_type> _type_map_info_type;

public:
	_vhid_info_lpu238(_mp::type_bm_dev type) : 
		_vhid_info(),
...
private:
	...
	* the set of lpu238 primitive and compositive data.
