    ...
    */
    namespace _coffee{
        ...
        */
        ...
        constexpr const wchar_t* CONST_S_COFFEE_MSR_INI_DIR_EXCEPT_BACKSLASH = L"C:\\job\\library.cpp.lpu230\\shared\\projects\\lpu237_dll";
        constexpr const wchar_t* CONST_S_COFFEE_IBUTTON_INI_DIR_EXCEPT_BACKSLASH = L"C:\\job\\library.cpp.lpu230\\shared\\projects\\lpu237_ibutton";
#else
        ...
        constexpr const wchar_t* CONST_S_COFFEE_MGMT_INI_DIR_EXCEPT_BACKSLASH = L"%ProgramData%\\elpusk\\programdata\\00000006\\coffee_manager";
        constexpr const wchar_t* CONST_S_COFFEE_MSR_INI_DIR_EXCEPT_BACKSLASH = L"%ProgramData%\\elpusk\\programdata\\00000006\\tg_lpu237_dll";
        constexpr const wchar_t* CONST_S_COFFEE_IBUTTON_INI_DIR_EXCEPT_BACKSLASH = L"%ProgramData%\\elpusk\\programdata\\00000006\\tg_lpu237_ibutton";
#endif //_DEBUG
#else
        ////////////////// LINUX
#ifdef _DEBUG
        ...
        constexpr const wchar_t* CONST_S_COFFEE_MSR_INI_DIR_EXCEPT_BACKSLASH = L"/home/tester/projects/LiElpuskHidDaemon/job/library.cpp.lpu230/shared/projects/tg_lpu237_dll";
        constexpr const wchar_t* CONST_S_COFFEE_IBUTTON_INI_DIR_EXCEPT_BACKSLASH = L"/home/tester/projects/LiElpuskHidDaemon/job/library.cpp.lpu230/shared/projects/tg_lpu237_ibutton";
        ...
        constexpr const wchar_t* CONST_S_PID_FILE_FULL_PATH = L"/var/run/elpusk-hid-d.pid";
        constexpr const wchar_t* CONST_S_COFFEE_MGMT_INI_DIR_EXCEPT_BACKSLASH = L"/usr/share/elpusk/programdata/00000006/coffee_manager";
        constexpr const wchar_t* CONST_S_COFFEE_MSR_INI_DIR_EXCEPT_BACKSLASH = L"/usr/share/elpusk/programdata/00000006/tg_lpu237_dll";
        constexpr const wchar_t* CONST_S_COFFEE_IBUTTON_INI_DIR_EXCEPT_BACKSLASH = L"/usr/share/elpusk/programdata/00000006/tg_lpu237_ibutton";
#endif //_DEBUG
#endif //_WIN32
