    ...
    */
    ...
    public:
		...
		*/
		...
		/**
		* @brief get ini file absolute path of tg_lpu237_tools.dll or libtg_lpu237_tools.so
		* @return absolute path of tg_lpu237_tools.ini.
		*/
		static std::wstring get_path_of_coffee_lpu237_tools_ini_file()
		{
			std::wstring s;
#if defined(_WIN32) && !defined(_DEBUG)
			//win release
			...
			p /= std::wstring(L"tg_lpu237_tools.ini");
			return p.wstring();
		}
