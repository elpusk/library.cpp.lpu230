...
crun_service& crun_service::get_instance()
{
	static crun_service service;
	return service;
}

DWORD crun_service::create_worker()
{
...
DWORD crun_service::launch_service()
{
...
bool crun_service::start_processes_different_session(DWORD dwSessionId)
{
	bool b_result(false);
...
bool crun_service::start_processes_different_session()
{
	return start_processes_different_session(::WTSGetActiveConsoleSessionId());
}

void crun_service::end_process()
{
...
bool crun_service::kill_service()
{
...
const std::wstring& crun_service::get_service_name() const { return m_s_service_name; }
const std::wstring& crun_service::get_ini_file_name() const { return  m_s_ini_file_name; }
const std::wstring& crun_service::get_exe_file_name() const { return m_s_service_exe_file_name; }

crun_service::crun_service(void) :
...
DWORD __stdcall crun_service::_service_handler_ex(DWORD dwControl, DWORD dwEventType, LPVOID lpEventData, LPVOID lpContext)
{
...
unsigned WINAPI crun_service::_worker(void* pParam)
{
	crun_service& svr = crun_service::get_instance();
...
void crun_service::_logging_process_info()
{
...
bool crun_service::_is_windows_version_or_greater(WORD wMajorVersion, WORD wMinorVersion, WORD wServicePackMajor)
{
