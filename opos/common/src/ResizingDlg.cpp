...
CResizingDlg::CResizingDlg(UINT nIDTemplate, CWnd* pParentWnd) : 
...
void CResizingDlg::SetControlInfo(WORD CtrlId,WORD Anchore)			
{
...
void CResizingDlg::OnGetMinMaxInfo(MINMAXINFO* lpMMI)
{
...
// OnCreate()
//
int CResizingDlg::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
//
LRESULT CResizingDlg::OnNcHitTest(CPoint point)
{
...
void CResizingDlg::GetDialogProfileEntry(CString &sEntry)
{
