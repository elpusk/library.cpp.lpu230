...
private:
	...
	typedef	DWORD (WINAPI *typeLPU237_enter_opos)( HANDLE  );
	typedef	DWORD (WINAPI *typeLPU237_leave_opos)( HANDLE  );
...
public:
	static CLpu237Dll & get_instance( const _tstring & s_dll_file_name = _tstring(_T("")) )
	{
	...
	DWORD LPU237_enter_opos( HANDLE  hDev )
	{
		if( m_FunLPU237_enter_opos )	return m_FunLPU237_enter_opos( hDev );
		else								return LPU237_DLL_RESULT_ERROR;
	}

	DWORD LPU237_leave_opos( HANDLE  hDev )
	{
		if( m_FunLPU237_leave_opos )	return m_FunLPU237_leave_opos( hDev );
		else								return LPU237_DLL_RESULT_ERROR;
	}
...
private:
	...
	typeLPU237_enter_opos m_FunLPU237_enter_opos;
	typeLPU237_leave_opos m_FunLPU237_leave_opos;
