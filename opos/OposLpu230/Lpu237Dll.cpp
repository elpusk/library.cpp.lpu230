...
void CLpu237Dll::ini()
{
	...
	m_FunLPU237_enter_opos = NULL;
	m_FunLPU237_leave_opos = NULL;
...
bool CLpu237Dll::Load( LPCTSTR sDll )
{
	...
	if( m_hMode ){
		...
		m_FunLPU237_enable = reinterpret_cast<typeLPU237_enable>( ::GetProcAddress( m_hMode, "LPU237_enable" ) );
		m_FunLPU237_disable = reinterpret_cast<typeLPU237_disable>( ::GetProcAddress( m_hMode, "LPU237_disable" ) );
			
		m_FunLPU237_enter_opos = reinterpret_cast<typeLPU237_enter_opos>( ::GetProcAddress( m_hMode, "LPU237_enter_opos" ) );
		m_FunLPU237_leave_opos = reinterpret_cast<typeLPU237_leave_opos>( ::GetProcAddress( m_hMode, "LPU237_leave_opos" ) );
