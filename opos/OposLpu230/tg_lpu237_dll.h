...
*/
typedef	void (WINAPI *type_callback)(void*);
...
*		else the number of connected lpu237 device.
*/
DWORD WINAPI LPU237_get_list_w( WCHAR *ssDevPaths	);
...
*		else the number of connected lpu237 device.
*/
DWORD WINAPI LPU237_get_list_a( CHAR *ssDevPaths	);
...
*	else return INVALID_HANDLE_VALUE
*/
HANDLE WINAPI LPU237_open_w( CONST WCHAR *sDevPath );
...
*	else return INVALID_HANDLE_VALUE
*/
HANDLE WINAPI LPU237_open_a( CONST CHAR *sDevPath );
...
/*!
* function
*	Don't use this function.( manufacture only )
*
* parameters
*	hDev : [in] device handle( return value of LPU237_open() )
*
...
*
*/
DWORD WINAPI LPU237_enter_opos( HANDLE hDev );
...
*
*/
DWORD WINAPI LPU237_leave_opos( HANDLE hDev );
...
*/
DWORD WINAPI LPU237_SCR_bypass_IccPowerOn( HANDLE hDev, BYTE cPower, BYTE *sRx,	LPDWORD lpnRx );
...
* 	concatenate Status & Error code. 
*/
DWORD WINAPI LPU237_SCR_bypass_IccPowerOff( HANDLE hDev );
...
* 	concatenate Status & Error code.
*/
DWORD WINAPI LPU237_SCR_bypass_XfrBlock( HANDLE hDev, BYTE cBWI,
	CONST BYTE *sTx,
	DWORD nTx,
	BYTE *sRx,
	LPDWORD lpnRx
...
* 	concatenate Status & Error code.
*/
DWORD WINAPI LPU237_SCR_bypass_GetParameters( HANDLE hDev, BYTE *sRx, LPDWORD lpnRx  );
...
* 	concatenate Status & Error code. 
*/
DWORD WINAPI LPU237_SCR_bypass_SetParameters( 
	HANDLE hDev,
	BYTE cProtocol,
	BYTE bmFindexDindex,
	BYTE bmTCCKST,
...
* 	concatenate Status & Error code. 
*/
DWORD WINAPI LPU237_SCR_bypass_ResetParameters( HANDLE hDev );
...
* 	concatenate Status & Error code. 
*/
DWORD WINAPI LPU237_SCR_bypass_GetSlotStatus( HANDLE hDev );
...
* 	concatenate Status & Error code.
*/
DWORD WINAPI LPU237_SCR_bypass_Escape( HANDLE hDev,
	CONST BYTE *sTx,
	DWORD nTx,
	BYTE *sRx,
	LPDWORD lpnRx
...
*/
BOOL WINAPI LPU237_SCR_helper_GetFirmwareVersion( HANDLE hDev, BYTE *sRx, LPDWORD lpnRx );
...
* 	concatenate Status & Error code.
*/
BOOL WINAPI LPU237_SCR_helper_GetReaderMode( HANDLE hDev, BYTE *lpcMode  );
...
*	else : result is success
*/
BOOL WINAPI LPU237_SCR_helper_SetReaderMode( HANDLE hDev, BYTE cMode, BYTE cPower );
...
* 	concatenate Status & Error code.
*/
BOOL WINAPI LPU237_SCR_helper_XfrBlock( HANDLE hDev,
	CONST BYTE *sTx,
	DWORD nTx,
	BYTE *sRx,
	LPDWORD lpnRx
...
*	else : result is success
*/
BOOL WINAPI LPU237_SCR_helper_SetCardParameters( HANDLE hDev, BYTE cProtocol, BYTE cParameter, BYTE cNewValue );
...
*	else : result is success
*/
BOOL WINAPI LPU237_SCR_helper_ResetCardParameters( HANDLE hDev );
...
*	else : result is success
*/
BOOL WINAPI LPU237_SCR_helper_result_is_success( DWORD dwScrResult );
...
*	else : result is success
*/
BOOL WINAPI LPU237_SCR_helper_SetParameters( HANDLE hDev ,CONST BYTE *sAtr, DWORD nAtr );
...
*	else : result is success
*/
BOOL WINAPI LPU237_SCR_helper_GetATRParameterString_w( WCHAR *sOut, LPDWORD lpnOut, CONST BYTE *sAtr,	DWORD nAtr, WCHAR cDelimiter );
...
*	else : result is success
*/
BOOL WINAPI LPU237_SCR_helper_GetATRParameterString_a( CHAR *sOut, LPDWORD lpnOut, CONST BYTE *sAtr,	DWORD nAtr, CHAR cDelimiter );
